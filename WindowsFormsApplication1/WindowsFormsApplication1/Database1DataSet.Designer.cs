...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string City, string Job, int Salary) {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([City] = @Original_City) AND ([Job] = @Original_Job) AND ([Salary] =" +
                " @Original_Salary))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [City], [Job], [Salary]) VALUES (@Name, @Ci" +
                "ty, @Job, @Salary);\r\nSELECT Id, Name, City, Job, Salary FROM Employee WHERE (Id " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [City] = @City, [Job] = @Job, [Salary] = @Salary WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([City] = @Original_City) AND ([Job] = @Original_Job) AND ([Salary] = @Original_Salary));
SELECT Id, Name, City, Job, Salary FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, City, Job, Salary FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_City, string Original_Job, int Original_Salary) {
        ...
        public virtual int Insert(string Name, string City, string Job, int Salary) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string City, string Job, int Salary, int Original_Id, string Original_Name, string Original_City, string Original_Job, int Original_Salary, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string City, string Job, int Salary, int Original_Id, string Original_Name, string Original_City, string Original_Job, int Original_Salary) {
            return this.Update(Name, City, Job, Salary, Original_Id, Original_Name, Original_City, Original_Job, Original_Salary, Original_Id);
        }
    }
